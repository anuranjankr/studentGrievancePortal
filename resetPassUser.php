...
if(!$mail->send()) {
 ...
 $sql_OTP = "UPDATE user_details SET otp = $OTP WHERE id = '$usrName'";
...
<div class="topnav">
  ...
  <div class="form-box">
    ...
    <form id="user" class="input-group" action="changePasswordUser.php?uName=<?php echo $usrName;?>" method="post">
